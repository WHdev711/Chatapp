...
class Constants {
  ...
  static String sharedPreferenceUserUid = "USERUID";
  ...
  static Future<bool> saveUserUidSharedPreference(String useruid) async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    return await preferences.setString(sharedPreferenceUserUid, useruid);
  }
  ...
  static Future<void> saveUserPhoneSharedPreference(String userPhone) async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
  ...
  static Future<String> getUserUidSharedPreference() async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    return preferences.getString(sharedPreferenceUserUid);
  }
