...
class _CountryPickerState extends State<CountryPicker> {
  ...
  void didChangeDependencies() async {
    if (widget.isInit) {
      ...
      setState(() {
        ...
        selectedCountryData = countryList[100];
      });
  ...
  Widget build(BuildContext context) {
    return Container(
      child: InkResponse(
        ...
        child: Container(
          padding:  EdgeInsets.fromLTRB(80, 2, 0, 7),
          child: Wrap(
  ...
  Future<void> showDialogue(BuildContext context) async {
    final countryData = await showDialog(
      context: context,
      builder: (BuildContext context) => CustomDialog1(
...
class _CustomDialogState extends State<CustomDialog1> {
